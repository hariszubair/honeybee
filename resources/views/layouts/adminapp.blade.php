...
<head>
 ...
 <!-- Fontfaces CSS-->
    ...
    <link href="{{ asset('public/css/datatables2.min.css') }}" rel="stylesheet" media="all">
...
<div class="page-wrapper">
                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{ URL('/admin-candidates')}}">
                                <i class="fas fa-table"></i>Candidates</a>
                        </li>
                        <li>
    ...
    <script src="{{ asset('public/js/datatables2.min.js') }}"></script>
    <!-- Main JS-->
